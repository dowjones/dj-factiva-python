...
class Extraction:
    ...
    def read_file(self, filepath, only_stats=True, merge_body=True) -> pd.DataFrame:
    ...
    def read_folder(self, folderpath, file_format='AVRO', only_stats=True, merge_body=True) -> pd.DataFrame:
